...
export default function TeamListingButtons(props) {
  ...
  return (    
      <>  
        <div class="dropdown">                          
            <button 
                onClick={(e)=>deleteTeamRequest(e, props.propsData.team_id)}
                type="button" 
        ...
        {openTeamModal && <TeamInfoModal setOpenTeamModal={setOpenTeamModal} modalData={props.propsData ? props.propsData : {}} modalType="update"/>}
